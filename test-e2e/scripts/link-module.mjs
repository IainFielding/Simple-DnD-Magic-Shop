 ...
 * the code in the repo rather than an installed copy.
 *
 * A junction rather than a symlink: it needs no elevation and works across volumes, which
 * matters here because the repo is on H: and Foundry's data on C:.
 *
